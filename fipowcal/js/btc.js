...
function dw() {
    var a=parseFloat(document.getElementById("tcost").value);
    var b=parseFloat(document.getElementById("abprice").value);
    var g=a*100/b;
    document.getElementById("bp").value=g;
}

function dq() {
    var a=parseFloat(document.getElementById("bp").value);
    var g=a/100*1;
    document.getElementById("btcost").value=g;
}

function e() {
    var a=parseFloat(document.getElementById("isum").value);
    var b=parseFloat(document.getElementById("btcost").value);
    var g=a-b;
...
document.getElementById('calculate').onclick = function() {
    a(); b(); ba(); bb(); c(); ca(); ci(); kk(); d(); cd(); xd(); rt(); zd(); ne(); yz(); dw(); dq(); e(); gf()
}
...
document.getElementById('save').onclick = function() {
    ...
    var y=" ";
    var kwh="Louhintalaitteiden kWh";
    ...
    var qw=" ";
    var ax="Yleissiirto Kulutusmaksu";
    ...
    var ta=" ";
    var ix="Kulut Yht.";
    var ui=parseFloat(document.getElementById("yleisku").value) + "+" + parseFloat(document.getElementById("perusve").value) + "+" + parseFloat(document.getElementById("sahkove").value) + "+" + parseFloat(document.getElementById("perusku").value) + "+" + parseFloat(document.getElementById("sahkoenergia").value) + "+" + parseFloat(document.getElementById("nettim").value);
    var iu="=" + parseFloat(document.getElementById("tcost").value) + " €";
    var l=" ";
    var pkb="Kulujen prosenttiosuus btc keskikurssista";
    var jk=parseFloat(document.getElementById("tcost").value) + "*100/" + parseFloat(document.getElementById("abprice").value);
    var kl="=" + parseFloat(document.getElementById("bp").value) + " %";
    var ys=" ";
    var ykb="Kulut Btc";
    var yk=parseFloat(document.getElementById("bp").value) + "/100*1";
    var qp="=" + parseFloat(document.getElementById("btcost").value) + " btc";
    var os=" ";
    var dz="Nettotulo";
    var m=parseFloat(document.getElementById("isum").value) + "-" + parseFloat(document.getElementById("btcost").value);
    var n="=" + parseFloat(document.getElementById("sum").value) + " btc";
    var v=[kkb, a, b, c, btb, d, e, f, kke, ab, abp, o, bbe, ba, bap, y, kwh, g, h, is, eha, erha, erta, sdf, ewq, srq, qrw, qw, ax, j, k, sa, za, as, ka, ls, ko, u, p, x, ey, et, er, yz, iz, po, pi, tr, ne, tt, im, ta, ix, ui, iu, l, pkb, jk, kl, ys, ykb, yk, qp, os, dz, m, n];
