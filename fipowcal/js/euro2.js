...
document.getElementById('calculate').onclick = function() {
    a(); b(); ba(); bb(); c(); ca(); ci(); kk(); d(); cd(); xd(); rt(); zd(); yz(); ne(); e(); gf()
}
...
document.getElementById('save').onclick = function() {
    ...
    var v=[kkb, a, b, c, btb, d, e, f, kke, ab, abp, o, bbe, ba, bap, y, kwh, g, h, l, eha, erha, erta, sdf, ewq, srq, qrw, qw, ax, j, k, sa, za, as, ka, ls, ko, u, p, x, ey, et, er, yz, iz, po, pi, tr, ne, tt, im, ta, ix, ui, iu, ce, dz, m, n];
