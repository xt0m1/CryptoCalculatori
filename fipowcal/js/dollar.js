...
document.getElementById('calculate').onclick = function() {
    a(); b(); c(); ca(); ci(); kk(); d(); cd(); xd(); rt(); zd(); ne(); yz(); e(); gf()
}
...
document.getElementById('save').onclick = function() {
    ...
    var b="=" + parseFloat(document.getElementById("aprice").value) + " $";
    var c=" ";
    var wr="Bruttotulo";
    var d=parseFloat(document.getElementById("income").value) + "*" + parseFloat(document.getElementById("aprice").value);
    var e="=" + parseFloat(document.getElementById("isum").value) + " $";
    var f=" ";
    ...
    var ce=" ";
    var dz="Nettotulo";
    var m=parseFloat(document.getElementById("isum").value) + "-" + parseFloat(document.getElementById("tcost").value);
    var n="=" + parseFloat(document.getElementById("sum").value) + " $";
    var v=[kk, a, b, c, wr, d, e, f, xz, g, h, i, eha, erha, erta, sdf, ewq, srq, qrw, qw, ax, j, k, sa, za, as, ka, l, ko, u, p, x, ey, et, er, yz, iz, po, pi, tr, ne, tt, im, ta, ix, ui, iu, ce, dz, m, n];
