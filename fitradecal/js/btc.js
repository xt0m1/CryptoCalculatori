...
document.getElementById('save').onclick = function() {
  ...
  if (x == z) {
    ...
    var b="=" + parseFloat(document.getElementById("buysum").value) + " btc";
    var c=" ";
    var mh="Myyntihinta";
    ...
    var hh="Hankintahinta";
    var a=parseFloat(document.getElementById("buy").value) + "*" + parseFloat(document.getElementById("bprice").value);
    var w="=" + parseFloat(document.getElementById("buysum").value) + " btc";
    var r=" ";
    var mh="Myyntihinta";
    var d=parseFloat(document.getElementById("sell").value) + "*" + parseFloat(document.getElementById("sprice").value);
    var y="=" + parseFloat(document.getElementById("sellsum").value) + " btc";
    var u=" ";
